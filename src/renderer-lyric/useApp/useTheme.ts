...
export default () => {
  ...
  watch(
    () => [
      setting['desktopLyric.style.lyricUnplayColor'],
      setting['desktopLyric.style.lyricPlayedColor'],
      setting['desktopLyric.style.lyricShadowColor'],
    ],
    ([unplayColor, playedColor, shadowColor]) => {
