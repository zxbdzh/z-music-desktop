<template>
  <div :class="[$style.player, 'player-shell']">
    <button
      type="button"
    ...
    >
      ...
      <div v-else :class="$style.emptyPic">Z</div>
    </button>
...
.playBtn {
  ...
  &:focus-visible { outline: 2px solid var(--color-focus, var(--color-primary)); outline-offset: 2px; }
  &:hover {
    opacity: 0.8;
  }
  &:active {
