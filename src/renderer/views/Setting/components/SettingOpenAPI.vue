...
dd.gap-top
  div
    .p
      ...
      strong.hover.underline(aria-label="https://ikunshare.github.io/lx-music-doc/desktop/faq/open-api" @click="openUrl('https://ikunshare.github.io/lx-music-doc/desktop/open-api')") {{ $t('setting__open_api_tip_link') }}
</template>
