...
export default () => {
  ...
  if (appSetting['player.soundEffect.convolution.fileName']) {
    void loadBuffer(appSetting['player.soundEffect.convolution.fileName']).then((buffer) => {
      setConvolver(
        buffer,
        appSetting['player.soundEffect.convolution.mainGain'] / 10,
  ...
  watch(
    () => appSetting['player.soundEffect.panner.speed'],
    (speed) => {
  ...
  watch(
    () => appSetting['player.soundEffect.convolution.mainGain'],
    (mainGain) => {
  ...
  watch(
    () => appSetting['player.soundEffect.convolution.sendGain'],
    (sendGain) => {
      if (!appSetting['player.soundEffect.convolution.fileName']) return
  ...
  watch(
    () => appSetting['player.soundEffect.biquadFilter.hz31'],
    (hz31) => {
      const bfs = getBiquadFilter()
  ...
  watch(
    () => appSetting['player.soundEffect.biquadFilter.hz62'],
    (hz62) => {
      const bfs = getBiquadFilter()
  ...
  watch(
    () => appSetting['player.soundEffect.biquadFilter.hz125'],
    (hz125) => {
      const bfs = getBiquadFilter()
  ...
  watch(
    () => appSetting['player.soundEffect.biquadFilter.hz250'],
    (hz250) => {
      const bfs = getBiquadFilter()
  ...
  watch(
    () => appSetting['player.soundEffect.biquadFilter.hz500'],
    (hz500) => {
      const bfs = getBiquadFilter()
  ...
  watch(
    () => appSetting['player.soundEffect.biquadFilter.hz1000'],
    (hz1000) => {
      const bfs = getBiquadFilter()
  ...
  watch(
    () => appSetting['player.soundEffect.biquadFilter.hz2000'],
    (hz2000) => {
      const bfs = getBiquadFilter()
  ...
  watch(
    () => appSetting['player.soundEffect.biquadFilter.hz4000'],
    (hz4000) => {
      const bfs = getBiquadFilter()
  ...
  watch(
    () => appSetting['player.soundEffect.biquadFilter.hz8000'],
    (hz8000) => {
      const bfs = getBiquadFilter()
  ...
  watch(
    () => appSetting['player.soundEffect.biquadFilter.hz16000'],
    (hz16000) => {
      const bfs = getBiquadFilter()
