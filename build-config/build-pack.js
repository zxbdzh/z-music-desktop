 ...
 */
const options = {
  // Keep the historical app ID and URL scheme until installed clients have a migration path.
...
const linuxOptions = {
  linux: {
    ...
    desktop: {
      ...
      entry: {
        Name: 'z-music-desktop',
        'Name[zh_CN]': 'z-music-desktop',
        'Name[zh_TW]': 'z-music-desktop',
        Encoding: 'UTF-8',
...
const macOptions = {
  ...
  dmg: {
    ...
    title: 'z-music-desktop v${version}',
  },
}
